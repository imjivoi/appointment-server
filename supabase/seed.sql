...
INSERT INTO public.businesses (name, description, slug, created_at, updated_at) VALUES ('My test business', 'My super business', 'my-business', timezone('utc'::text, now()), timezone('utc'::text, now()));

-- insert into public.business(name, description, )
--   values ('185f2f83-d63a-4c9b-b4a0-7e4a885799e2', 'test', 'test', timezone('utc'::text, now()), timezone('utc'::text, now()));